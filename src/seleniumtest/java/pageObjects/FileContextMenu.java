...
public class FileContextMenu {
	...
	public void click(String item) throws Exception{
		...
		case "Lock":
			...
			break;
		case "Unlock":
			action.click(driver.findElement(By.xpath("//div[starts-with(@eventproxy,'isc_ContextMenu_')]/div/table/tbody/tr[12]/td")))
			.sendKeys(Keys.RETURN).build().perform();
			break;
		case "Index":
			action.click(driver.findElement(By.xpath("//div[starts-with(@eventproxy,'isc_ContextMenu_')]/div/table/tbody/tr[13]/td")))
			.sendKeys(Keys.RETURN).build().perform();
			action.click(driver.findElement(By.xpath("//div[starts-with(@eventproxy,'isc_Menu_')]//table/tbody/tr[1]/td")))
			.sendKeys(Keys.RETURN).build().perform();
			break;
		case "Mark indexable":
			action.click(driver.findElement(By.xpath("//div[starts-with(@eventproxy,'isc_ContextMenu_')]/div/table/tbody/tr[13]/td")))
			.sendKeys(Keys.RETURN).build().perform();
			action.click(driver.findElement(By.xpath("//div[starts-with(@eventproxy,'isc_Menu_')]//table/tbody/tr[2]/td")))
			.sendKeys(Keys.RETURN).build().perform();
			break;
		case "Mark unindexable":
			action.click(driver.findElement(By.xpath("//div[starts-with(@eventproxy,'isc_ContextMenu_')]/div/table/tbody/tr[13]/td")))
			.sendKeys(Keys.RETURN).build().perform();
			action.click(driver.findElement(By.xpath("//div[starts-with(@eventproxy,'isc_Menu_')]//table/tbody/tr[3]/td")))
			.sendKeys(Keys.RETURN).build().perform();
			break;
		case "Mark immutable":
			action.click(driver.findElement(By.xpath("//div[starts-with(@eventproxy,'isc_ContextMenu_')]/div/table/tbody/tr[13]/td")))
			.sendKeys(Keys.RETURN).build().perform();
			action.click(driver.findElement(By.xpath("//div[starts-with(@eventproxy,'isc_Menu_')]//table/tbody/tr[4]/td")))
			.sendKeys(Keys.RETURN).build().perform();
			break;
		case "Sign":
			action.click(driver.findElement(By.xpath("//div[starts-with(@eventproxy,'isc_ContextMenu_')]/div/table/tbody/tr[13]/td")))
			.sendKeys(Keys.RETURN).build().perform();
			action.click(driver.findElement(By.xpath("//div[starts-with(@eventproxy,'isc_Menu_')]//table/tbody/tr[5]/td")))
			.sendKeys(Keys.RETURN).build().perform();
			break;
		default:
